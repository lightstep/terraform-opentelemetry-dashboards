...
* __OpenTelemetry Collectors running in Kubernetes__ (module: [`otel-collector-dashboard`](https://github.com/lightstep/terraform-opentelemetry-dashboards/tree/main/collector-dashboards/otel-collector-dashboard))
...
* __Host Metrics __ (module: [`otel-collector-host-metrics-dashboard`](https://github.com/lightstep/terraform-opentelemetry-dashboards/tree/main/collector-dashboards/otel-collector-host-metrics-dashboard))
...
* __OpenTelemetry Collector Comprehensive Kubernetes Dashboard (Prometheus)__ (module: [`otel-collector-kubernetes-comprehensive-dashboard-prometheus`](https://github.com/lightstep/terraform-opentelemetry-dashboards/tree/main/collector-dashboards/otel-collector-kubernetes-comprehensive-dashboard-prometheus))
